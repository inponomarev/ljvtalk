...
* Want to make https://ponomarev.uk/blog/presentation.html[slides as code]
* *Is it possible for the slides to draw themselves?*

== Slides as Code

https://ponomarev.uk/blog/presentation.html

== GraphViz (Graph Visualization Software)

* Initial release: before 1991
* Latest release: 11.0.0, May 2024
...
== Lightweight Java Visualizer reborn

* Nuras Nogaev, Ilya Selivanov (MIPT)
* Improved API
* Updated GraphViz
* GitHub, Maven, CI, tests
...
== Step 2: Creating the Object of Study
